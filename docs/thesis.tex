...
\subsection{Neuronové síť}

\subsubsection{Klasifikace hvězdy}

Na základě povrchové teploty 

\img[2]{Klasifikace hvězdy~--~trénovací množina (vlevo) a~HR diagram (vpravo)}{img/hr_diagram.png}
{\setstretch{0.8}\footnotetext[2]{Graf trénovací množiny vytvořen autorem, HR diagram převzat z~Wikimedia Commons pod licencí CC BY-SA 3.0 (\url{https://creativecommons.org/licenses/by-sa/3.0}), přidány popisky}}

...
Planety u~jiných hvězd většinou nelze pozorovat přímo. Proto je nepřímými metodami zkoumáno jejich působení na své mateřské hvězdy, které už pozorovat lze. Výstupem z~takovýchto pozorování jsou často stovky GiB nebo jednotky TiB fyzikálních a~statistických dat, jež je následně nutno zpracovat.~\cite{exoplanets}
...
\footnotetext[1]{Vytvořeno autorem, zdroj dat:~\cite{nasadata}}
...
\footnotetext[1]{Vytvořeno autorem, zdroj dat: \cite{sunlight}.}
...
\footnotetext[1]{Vytvořeno autorem, zdroj dat: \cite{51pegasi}.}
...
\footnotetext[1]{Vytvořeno autorem, zdroj dat: \cite{radialvelocity, 51pegasi, methods, nasadata}.}

...
V tabulce 4 jsou uvedeny příklady výpočtu hmotnosti některých planet.
...
V~případě, kdy se nějaké hmotné těleso (např. galaxie nebo černá díra) nachází mezi pozorovatelem a~zdrojem světla (např. jinou galaxií), mluvíme o~tzv. gravitační čočce~--~zdroj světla bude vidět vícekrát na různých místech, nebo bude naopak zdeformovaný.~\cite{methods}

\img[1]{Princip gravitační čočky}{img/lens.png}

\footnotetext[1]{Vytvořeno autorem, fotografie gravitační čočky převzata od NASA (\url{https://apod.nasa.gov/apod/image/1112/lensshoe_hubble_3235.jpg}), oříznuto a~zdeformováno}

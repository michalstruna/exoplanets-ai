...
export default {
    ...
    stars: {
        ...
        surface_gravity: { [CS]: 'Gravitace', [EN]: 'Gravity' },
    ...
    planets: {
        ...
        density: { [CS]: 'Hustota', [EN]: 'Density' },
        surface_temperature: { [CS]: 'Teplota', [EN]: 'Temperature' },
        semi_major_axis: { [CS]: 'Velká poloosa', [EN]: 'Semi-major axis' },
        transit: { [CS]: 'Tranzit', [EN]: 'Transit' },
        orbital_period: { [CS]: 'Perioda', [EN]: 'Period' },
        orbital_velocity: { [CS]: 'Rychlost', [EN]: 'Velocity' },
        life_conditions: { [CS]: 'Život', [EN]: 'Life' },
        planet: { [CS]: 'Planeta', [EN]: 'Planet' },
        status: 'Status',
        eccentricity: { [CS]: 'Excentricita', [EN]: 'Eccentricity' },
        surface_gravity: { [CS]: 'Gravitace', [EN]: 'Gravity' },

...
import { Cursor, TextValue } from '../../Data'
...
export const provideFilterColumns = (table: DbTable, strings: any): [string, string, TextValue[] | StringConstructor | NumberConstructor][] => {
    switch (table) {
        case DbTable.BODIES:
            return []
        case DbTable.STARS:
        ...
        case DbTable.PLANETS:
            return [
                ...
                ['datasets', strings.properties.dataset, String]
            ]

...
const getStarTypes = (strings: any) => {
    const result = []

    for (const lumClass of Object.values(LuminosityClass)) {
        for (const spectClass of Object.values(SpectralClass)) {
            result.push({ text: spectClass + ' ' + lumClass, value: spectClass + '_' + lumClass })
        }
    }

                ...
                levels: [
                    {
                        columns: Col.list<StarData>([
                            ...
                            { name: 'transit_depth', format: (_, item) => item.light_curves[0] && <Curve data={item.light_curves[0].flux} color='#FAA' simple={true} />, title: <Colored color='#FAA'>{strings.properties.lightCurve}</Colored>, width: '20rem' },
                    ...
                    },
                    {
                        columns: Col.list<PlanetData>([
                            ...
                            { name: 'transit_depth', format: (_, planet) => <Curve data={planet.properties[0].transit!.flux} color='#AFA' simple={true} />, title: <Colored color='#AFA'>{strings.properties.transit}</Colored>, width: '20rem' },
                ...
                levels: [
                    {
                        columns: Col.list<StarData>([
                            ...
                            { name: 'planets', format: (val, item) => item.planets.length },
                            { name: 'transit_depth', format: () => <Curve data={[]} color='#FAA' simple={true} />, title: <Colored color='#FAA'>{strings.properties.lightCurve}</Colored>, width: '20rem' },
                ...
                levels: [
                    {
                        columns: Col.list<PlanetData>([
                            ...
                            { name: 'transit_depth', format: () => <Curve data={[]} color='#AFA' simple={true} />, title: <Colored color='#AFA'>{strings.properties.transit}</Colored>, width: '20rem' },

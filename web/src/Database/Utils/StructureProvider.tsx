                ...
                levels: [
                    {
                        columns: [
                            ...
                            },
                            {
                                ...
                                icon: '/img/Database/Table/Diameter.svg',
                                render: (v: any) => <>{v} km<br />{v} km<br />{v} km</>
                            },
                            {
                                title: 'Hmotnost',
                                accessor: (star: any) => star.mass,
                                icon: '/img/Database/Table/Mass.svg'
                            },
                            {
                                title: 'Teplota',
                                accessor: (star: any) => star.temperature,
                                icon: '/img/Database/Table/Temperature.svg'
                            },
                            {
                                title: 'Zářivý výkon',
                                accessor: (star: any) => star.luminosity,
                                icon: '/img/Database/Table/Luminosity.svg'
                            },
                            {
                                title: 'Vzdálenost',
                                accessor: (star: any) => star.distance,
                                icon: '/img/Database/Table/Distance.svg'
                            },
                            {
                                title: 'Planet',
                                accessor: (star: any) => star.planets.length,
                                icon: '/img/Database/Table/Planet.svg'
                            },
                            {
                                title: '',
                                accessor: (star: any) => star.planets.length,
                    ...
                    },
                    {
                        columns: [
                            ...
                            },
                            {
                                ...
                                icon: '/img/Database/Table/Period.svg'
                            },
                            {
                                title: 'Poloosa',
                                accessor: (planet: any) => planet.semiMajorAxis,
                                icon: '/img/Database/Table/Orbit.svg'
                            },
                            {
                                title: 'Rychlost',
                                accessor: (planet: any) => planet.orbitalVelocity,
                                icon: '/img/Database/Table/Velocity.svg'
                            },
                            { title: 'Život', accessor: () => 'Vyloučen', icon: '/img/Database/Table/Life.svg' },
                            {
                                title: 'Metoda',
                                accessor: () => '',
                                render: () => <>Tranzit<br />Radiální rychlost</>,
                                icon: '/img/Database/Table/Discovery.svg',
                                width: '20rem'
                            }
                        ],
                ...
                levels: [
                    {
                        columns: [
                            ...
                            },
                            {
                                ...
                                render: (_, star) => (
                                    <>
                                        <MultiValue items={star.properties} property='dataset' formatter={val => <IconText text={val} icon='/img/Database/Star.svg' />} />
                                    </>
                                ),
